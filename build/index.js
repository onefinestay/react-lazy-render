...
/***/ function(module, exports, __webpack_require__) {
	...
	var Nonsense = __webpack_require__(216);
	...
	var LazyRender = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	var Index = React.createClass({displayName: 'Index',
	  ...
	  render: function() {
	    ...
	    var rows = _.range(this.state.limit).map(function(row) {
	      var index = row % 50;
	      return React.createElement("div", {style: { height: 20, padding: "5px 10px"}}, 
	        "#", row + 1, " ", NAMES[index]
	      );
	    });
	    ...
	    return (
	      React.createElement("html", null, 
	        React.createElement("head", null, 
	          React.createElement("title", null, "React Lazy Render Demo"), 
	        ...
	        React.createElement("body", null, 
	          ...
	          React.createElement("div", {className: "content"}, 
	            React.createElement("div", {className: "examples"}, 
	              React.createElement("div", {className: "example-controls"}, 
	                React.createElement("div", {className: "example-controls__count"}, 
	                  "Viewing ", this.state.limit / 1000, "K records"
	                ), 
	                React.createElement("div", {className: "example-controls__limits"}, 
	                  React.createElement("a", {href: "#", className: "example-controls__button", 
	                    onClick: this.handleClick.bind(null, 5000)}, 
	                    "5K Records"
	                  ), 
	                  React.createElement("a", {href: "#", className: "example-controls__button", i: true, 
	              ...
	              React.createElement(LazyRender, {maxHeight: 200, className: "example-container"}, 
	                rows
	              )
	            ), 
	  ...
	  render: function() {
	    return (
	      React.createElement("header", {className: "header"}, 
	        React.createElement("h1", {className: "header__title"}, "React Lazy Render")
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactCSSTransitionGroup = __webpack_require__(15);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CSSCore = __webpack_require__(160);
	var ReactTransitionEvents = __webpack_require__(161);
